          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-8 mb-12 bg-gradient-to-r from-gray-900 to-black rounded-2xl border border-gray-800">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm mb-1">
                  Digital Address: GD-028-0477
                </p>
                <p className="text-gray-400 text-sm">
                  Pick-up Location: Adenta
                </p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  An Agribusiness that started as a backyard poultry farm in
                  2017.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="relative mb-6">
                ...
                <p className="text-gray-300 text-lg mb-4 max-w-md">
                  Poultry Products Since 2017
                </p>

                {/* Description with subtle animation */}
                <div className="relative group">
                  <p className="text-gray-400 mb-6 max-w-md transition-all duration-300 group-hover:text-gray-300">
                    Providing farm-fresh poultry products with unmatched
                    quality, hygiene, and customer service. From our farms to
                    your table with care and excellence.
                  </p>
            ...
            {[
              ...
              },
              {
                ...
                links: [
                  {
                    name: "Facebook",
                    url: "https://www.facebook.com/NayaSuccessAxis/",
                    icon: Facebook,
                  },
                  {
                    name: "Instagram",
                    url: "https://www.instagram.com/nayasuccessaxisfarms/",
                    icon: Instagram,
                  },
                  {
                    name: "YouTube",
                    url: "https://youtu.be/huUjY541_jo?si=4b3kuwjj77b7Ttl6",
                    icon: Youtube,
                  },
                  {
                    name: "WhatsApp",
                    url: "https://wa.me/233244384928",
                    icon: MessageCircle,
                  },
                ],
              },
