...
const heroImage = "https://res.cloudinary.com/dgk47100y/image/upload/v1767571346/u1npaxgb3hzye5sfun0y.jpg";

const heroData = {
  heroMessages: [
  {
    title: "Naya Success Axis",
    description: "NAYA SUCCESS AXIS is an Agribusiness that started as a backyard poultry farm in 2017.",
  },
  {
            ...
            <div className="flex items-center justify-center pt-4 space-x-4">
              <Link to="/products">
                <button className="inline-flex items-center gap-3 px-6 py-3 bg-lime-500 hover:bg-lime-400 text-black font-semibold rounded-full transition-all duration-300 hover:scale-105 active:scale-95">
                  ...
                  <ArrowRight className="w-5 hidden md:block h-5 md:w-6 md:h-6"/>
                </button>
              </Link>
              <Link to="/about">
